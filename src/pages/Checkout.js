  ...
  return (
    <section className="section form">
      ...
      <form className="checkout-form">
        ...
        <AddressSection handleChange={handleChange} setName={setName} />
        {/* end of single input */}
        {/* card element */}
...
const StripeWrapper = () => {
  return (
    <StripeProvider apiKey="pk_test_51Gtrz1Fp4fFhc1FrPOoe21m6XVFI9rHsPTDZhwDUEg1Y58i38PQHgu9PVPzVN7u3To5QwF4U3VcxaKbC1eWvVmsW00gNdrtlud">
      <Elements>
        <CardForm></CardForm>
      </Elements>
    </StripeProvider>
